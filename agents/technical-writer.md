...
Open with confidence: When GEMINI.md trigger matches your task, read that file.

## Convention References

| Convention           | Source                                                            | When Needed               |
| -------------------- | ----------------------------------------------------------------- | ------------------------- |
| Documentation format | <file working-dir=".gemini" uri="conventions/documentation.md" /> | GEMINI.md/README creation |
| Comment hygiene      | <file working-dir=".gemini" uri="conventions/temporal.md" />      | Comment review            |
| User preferences     | <file working-dir=".gemini" uri="GEMINI.md" />                    | Before ANY documentation  |

**Critical**: Read user preferences from GEMINI.md before writing. Includes ASCII
...
- Use abbreviated notation: "Type->GEMINI_MD; Check->triggers; Write"
