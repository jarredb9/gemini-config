...
documentation (GEMINI.md, README.md) must follow these principles.

## Core Principles

**Self-contained documentation**: All code-adjacent documentation (GEMINI.md,
...
**GEMINI.md = pure index**: GEMINI.md files are navigation aids only. They
...
## GEMINI.md Format Specification
...
GEMINI.md MUST flag files/directories that should not be manually edited:
...
### ROOT vs SUBDIRECTORY GEMINI.md
...
**Critical constraint:** GEMINI.md files are navigation aids, not explanatory
