...
The GEMINI.md/README.md hierarchy is central to context hygiene. GEMINI.md files
...
2. **Audit** -- Checks for drift (files added/removed but not indexed),
   misplaced content (architecture docs in GEMINI.md instead of README.md)
3. **Migration** -- Moves architectural content from GEMINI.md to README.md
