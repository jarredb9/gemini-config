...
<invoke working-dir=".gemini/skills/scripts" cmd="python3 -m skills.prompt_engineer.optimize --step 1" />

Then continue with determined scope:

<invoke working-dir=".gemini/skills/scripts" cmd="python3 -m skills.prompt_engineer.optimize --step 2 --scope <scope>" />
