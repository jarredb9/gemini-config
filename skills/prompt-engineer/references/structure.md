...
Gemini continues from the prefill, maintaining the JSON structure. The model
...
- (+) Works with any model supporting assistant prefill (Gemini, GPT-4)
...
- Exception: Gemini-specific XML patterns work well when used for structure:
