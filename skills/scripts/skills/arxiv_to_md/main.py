...
DISCOVER_INSTRUCTIONS = (
    ...
    "  - GEMINI.md in current directory (may list arXiv IDs)\n"
...
MODE1_TEMPLATE = (
    ...
    "arXiv ID: $ARXIV_ID\n"
    "\n"
    "Start: <invoke working-dir=\".gemini/skills/scripts\" cmd=\"python3 -m skills.arxiv_to_md.sub_agent --step 1 --arxiv-id $ARXIV_ID\" />\n"
    "\n"
    "<expected_output>\n"
...
MODE2_TEMPLATE = (
    ...
    "\n"
    "Start: <invoke working-dir=\".gemini/skills/scripts\" cmd=\"python3 -m skills.arxiv_to_md.sub_agent --step 1 --arxiv-id $ARXIV_ID --dest-file '$DEST_FILE'\" />\n"
    "\n"
    "<expected_output>\n"
    "Sub-agent responds with ONLY:\n"
    "\n"
