...
STEPS = {
    1: {
        ...
        "actions": [
            "CODEBASE SURVEY",
            "",
            "Gather MINIMAL context (README first 50 lines, GEMINI.md, dir listing).",
    ...
    3: {
        ...
        "actions": [
            ...
            f'  Start: <invoke working-dir=".gemini/skills/scripts" cmd="python3 -m {MODULE_PATH} --step-number 4 --thoughts \\"Dimension: {{{{letter}}}}\\"" />',
        ],
    ...
    9: {
        ...
        "actions": [
            ...
            f'  Start: <invoke working-dir=".gemini/skills/scripts" cmd="python3 -m {MODULE_PATH} --step-number 10 --thoughts \\"Verifying: {{{{id}}}}\\"" />',
        ],
    ...
    17: {
        ...
        "actions": [
            ...
            f'  Start: <invoke working-dir=".gemini/skills/scripts" cmd="python3 -m {MODULE_PATH} --step-number 18 --thoughts \\"FILE: {{{{file}}}}\\"" />',
            "",
