...
.gemini/conventions/ (not skill-specific resources directories).

Available conventions:
- documentation.md: GEMINI.md/README.md format specification
...
def get_convention(name: str) -> str:
    ...
    """
    # parents[4]: lib -> skills -> scripts -> skills -> .gemini
