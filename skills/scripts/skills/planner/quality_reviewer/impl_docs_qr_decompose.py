...
Scope: Post-implementation documentation.
  - GEMINI.md format (tabular index)
...
Brainstorm concerns specific to POST-IMPL DOCUMENTATION:
  - GEMINI.md missing or wrong format (tabular index required)
...
DIRECTORIES:
  ...
  - GEMINI.md exists? Format correct?
