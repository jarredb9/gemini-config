...
6-step workflow for technical-writer sub-agent:
  ...
  3. GEMINI.md Index Format (tabular format rules)
    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "DELIVERABLES:",
                "  1. GEMINI.md index entries for modified directories",
        ...
        return {
            ...
            "actions": [
                ...
                "   - Group by directory for GEMINI.md updates",
                "",
                "3. MILESTONE DESCRIPTIONS:",
                "   - What each milestone accomplished",
                "   - Use for WHAT column in GEMINI.md index",
                "",
        ...
        return {
            "title": STEPS[3],
            "actions": [
                "UPDATE GEMINI.md for each modified directory.",
                "",
                ...
                "",
                "IF GEMINI.md exists but NOT tabular:",
                "  REWRITE completely (do not improve, replace)",
                "",
                "FORBIDDEN in GEMINI.md:",
